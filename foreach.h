...
#ifdef ZLIB_H
#define _myopen(f,t) ((t==1) ? stdin : (t==-1) ? popen((f)+1,"r") : (FILE *) gzopen((f),"r"))
#define _myclose(p,t) ((t==1) ? 0 : (t==-1) ? pclose(p) : gzclose((gzFile) p))
#define _fgets(s,n,p,t) ((t) ? fgets(s,n,p) : gzgets((gzFile) p,s,n))
#else
...
#define foreach_line(str, fname) \
  for (char str[_LINE], _ft = _ftype(fname), \
	 *_fp = (str[_LINE-1] = 1, errno = 0, (char*) _myopen(fname, _ft)); \
       ...
       _fp = (char *) (_myclose((FILE*)_fp, _ft), NULL))		    \
